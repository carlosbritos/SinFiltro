...
$(document).ready(function(){
  ...
  // $('.responsable-color').on( "click", function(){
  //   $('.dorado').css('visibility','visible');
  // })

  // $('.divertido').on( "click", function(){
  //   $('.rojo').css('visibility','visible');
  // })


  // $('.construction').on( "click", function(){
  //   $('.construction').css('visibility','hidden');
  // })
